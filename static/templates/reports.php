...
<hr>
<button type="button" id="add_report" class="btn btn-primary">Create Report</button>
<button type="button" id="search_report" class="btn btn-primary">Search Reports</button>
...
$( document ).ready(function() {
	$( "#search_report" ).click(function() {
	    $("#list").fadeIn("slow").load( "templates/search.php" );
		return false;
	});
	...
	<br /><br />
		...
		<b>Reports in system:</b><?=$reports_count;?><br />
		<!-- paging table -->	
		...
		<script>
			...
			$( document ).ready(function(e) {
				...
				$( "#back_button" ).click(function(e) {
					...
					$("#list").fadeIn("slow").load( "templates/reports.php?page_start="+parseInt(paging_start)+"&page_range="+parseInt(paging_range) ); //ajaxy production live version paradox don't exist nor can you create one, see regrets clause of book. 
					return false;
				});
				...
				$( "#next_button" ).click(function(e) {
				    ...
				    $("#list").fadeIn("slow").load( "templates/reports.php?page_start="+parseInt(paging_start)+"&page_range="+parseInt(paging_range) ); //ajaxy production live version
					return false;
				});
