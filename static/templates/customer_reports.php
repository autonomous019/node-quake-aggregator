...
<script>
    ...
    $reports = $r->get_my_reports($my_id);
						...
						<div class="modal-dialog modal-lg">
					      <div class="modal-content">
					        <div class="modal-header">
					          ...
					          <h4 class="modal-title">PDF Viewer: <a href="reports/<?= $file_info; ?>"><?= $file_info; ?></a></h4>
					        </div>
					        <div class="modal-body" style="min-height: fill-available;">
					          <!-- content and stuff -->
				  
				  
				               <embed src="reports/<?= $file_info; ?>" id="pdf_view_file" width="94%" height="400px" alt="pdf" pluginspage="http://www.adobe.com/products/acrobat/readstep2.html">
